...
var _library = document.querySelector('.library'),
    _book = document.querySelector('.book'),
    _add = document.querySelector('.add'),
...
router.on({
  '/': function _() {
    ...
    _library.classList.remove('hidden');
  },
